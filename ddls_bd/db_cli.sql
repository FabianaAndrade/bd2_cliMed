...
DROP TABLE IF EXISTS EXERCE_ESPECIALIDADE CASCADE;
DROP TABLE IF EXISTS DIAGNOSTICA CASCADE;
...
CREATE TABLE IF NOT EXISTS  CONSULTA (
	...
	CONSTRAINT chk_tipo_pg CHECK (UPPER(FormaPagamento) in ('DINHEIRO', 'CARTÃO', 'CHEQUE'))
);
